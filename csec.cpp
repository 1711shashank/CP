...
void solve(){
    ...
    // formula
    double amount = x + y;
    double principle1 = x - (x*d*1.0)/100;

    double time = (log(amount/principle1)) / (log((100+a)*1.0/100));
    p1( ceil(time) );

    
    
    // loop
    // double principle = x - (x*d*1.0)/100;
    // double amount1 = x + y;
    // ll loop = 30000;
    // ll day=0;
    // while (loop--){
    //     day++;
    //     double rate = (a*1.0/100) * principle;
    //     principle = principle + rate;
    //     // p2(day, principle);

    //     if( principle >= amount1 ){
    //         break;
    //     }
...
int32_t main(){
    ...
    // freopen("Codechef_I2.txt", "r", stdin);
